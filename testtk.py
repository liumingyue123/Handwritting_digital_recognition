...
def callback():
    #屏幕size=1536*864
    im0 = ImageGrab.grab((170,50,795,510))
    #im0.show()
...
la=ttk.Button(master, text="start",width=15,command=callback).place(x=5,y=100)
ttk.Button(master, text="clear",width=15,command=(lambda x=ALL:w.delete(x))).place(x=5,y=200)
